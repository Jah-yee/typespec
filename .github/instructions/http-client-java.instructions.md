...
2. Create a new branch. The name must follow the pattern "UseESRP_publish/http-client-java-<version>". Remind user that this branch must be pushed to remote upstream.
